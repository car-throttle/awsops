...
helper.deleteObjects = function (config, opts, callback) {
  ...
  var s3 = (config.constructor instanceof AWS.S3.constructor) ? config : (new AWS.S3(config || {}));
...
helper.lookupEc2Instances = function (config, opts, callback) {
  ...
  var ec2 = (config.constructor instanceof AWS.EC2.constructor) ? config : (new AWS.EC2(config || {}));
